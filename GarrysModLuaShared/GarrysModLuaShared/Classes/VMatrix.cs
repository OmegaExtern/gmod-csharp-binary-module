...
{
    /// <summary>Representation of a mathematical construct that allows Vectors to be transformed. This object can be created with <see cref="Global.Matrix"/> function.</summary>
    public sealed class VMatrix : LuaObject
    {
        ...
        /// <summary>Gets the forward direction of the matrix.<para/>ie. The first column of the matrix, excluding the w coordinate.</summary>
        /// <returns>The forward direction of the matrix.</returns>
        public Vector GetForward() => CallObject(nameof(GetForward)).ToVector();

        /// <summary>Returns an inverted matrix without modifying the original matrix.<para/>Inverting the matrix will fail if its <see cref="https://en.wikipedia.org/wiki/Determinant">determinant</see> is 0 or close to 0. (ie.its "scale" in any direction is 0.)<para/>See also <seealso cref="GetInverseTR"/>.</summary>
        ...
        /// <summary>Returns an inverted matrix without modifying the original matrix. This function will not fail, but only works correctly on matrices that contain only translation and/or rotation.<para/>Using this function on a matrix with modified scale may return an incorrect inverted matrix.<para/>To get the inverse of a matrix that contains other modifications, see <seealso cref="GetInverse"/>.</summary>
        /// <returns>The inverted matrix.</returns>
        public VMatrix GetInverseTR() => CallObject(nameof(GetInverseTR)).ToVMatrix();

        /// <summary>Gets the right direction of the matrix.<para/>ie. The second column of the matrix, negated, excluding the w coordinate.</summary>
        ...
        /// <summary>Gets the up direction of the matrix.<para/>ie. The third column of the matrix, excluding the w coordinate.</summary>
        ...
        /// <summary>Inverts the matrix.<para/>Inverting the matrix will fail if its <see cref="https://en.wikipedia.org/wiki/Determinant">determinant</see> is 0 or close to 0. (ie.its "scale" in any direction is 0.)<para/>If the matrix cannot be inverted, it does not get modified.<para/>See also <seealso cref="InvertTR"/>.</summary>
        /// <returns>Whether the matrix was inverted or not.</returns>
        public bool Invert() => CallBoolean(nameof(Invert));

        /// <summary>Inverts the matrix. This function will not fail, but only works correctly on matrices that contain only translation and/or rotation.<para/>Using this function on a matrix with modified scale may return an incorrect inverted matrix.<para/>To invert a matrix that contains other modifications, see <seealso cref="Invert"/>.</summary>
        ...
        /// <summary>Returns whether the matrix is a rotation matrix or not.<para/>Technically it checks if the forward, right and up vectors are orthogonal and normalized.</summary>
        /// <returns>Is the matrix a rotation matrix or not.</returns>
        public bool IsRotationMatrix() => CallBoolean(nameof(IsRotationMatrix));

        /// <summary>Rotates the matrix by the given angle.<para/>Postmultiplies the matrix by a rotation matrix(A = AR).</summary>
        /// <param name="rotation">Rotation angle.</param>
        public void Rotate(Angle rotation) => CallVoid(nameof(Rotate), rotation);

        /// <summary>Scales the matrix by the given vector.<para/>Postmultiplies the matrix by a scaling matrix(A = AS).</summary>
        ...
        /// <summary>Sets the forward direction of the matrix.<para/>ie. The first column of the matrix, excluding the w coordinate.</summary>
        ...
        /// <summary>Sets the right direction of the matrix.<para/>ie. The second column of the matrix, negated, excluding the w coordinate.</summary>
        ...
        /// <summary>Sets the up direction of the matrix.<para/>ie. The third column of the matrix, excluding the w coordinate.</summary>
        ...
        /// <summary>Translates the matrix by the given vector aka. adds the vector to the translation.<para/>Postmultiplies the matrix by a translation matrix(A = AT).</summary>
