...
{
    /// <summary>
    ///     Representation of a three-dimensional Euler angle. Use <see cref="Global.Angle" /> function to create an
    ...
    public sealed class Angle : LuaObject, IEquatable<Angle>
    {
        ...
        public double pitch
        {
            get { return _p = _pitch = GetFieldNumber(nameof(pitch)); }
            set { SetField(nameof(pitch), _p = _pitch = value); }
        }

        /// <summary>The yaw component of the angle (rotation around the Y axis). +Left/-Right.</summary>
        public double yaw
        {
            get { return _y = _yaw = GetFieldNumber(nameof(yaw)); }
            set { SetField(nameof(yaw), _y = _yaw = value); }
        }

        /// <summary>The roll component of the angle (rotation around the Z axis). +Right/-Left.</summary>
        public double roll
        {
            get { return _r = _roll = GetFieldNumber(nameof(roll)); }
            set { SetField(nameof(roll), _r = _roll = value); }
        }

        /// <summary>The pitch component of the angle (rotation around the X axis). +Down/-Up.</summary>
        public double p
        {
            get { return _pitch = _p = GetFieldNumber(nameof(p)); }
            set { SetField(nameof(p), _pitch = _p = value); }
        }

        /// <summary>The yaw component of the angle (rotation around the Y axis). +Left/-Right.</summary>
        public double y
        {
            get { return _yaw = _y = GetFieldNumber(nameof(y)); }
            set { SetField(nameof(y), _yaw = _y = value); }
        }

        /// <summary>The roll component of the angle (rotation around the Z axis). +Right/-Left.</summary>
        public double r
        {
            get { return _roll = _r = GetFieldNumber(nameof(r)); }
            set { SetField(nameof(r), _roll = _r = value); }
        }
        ...
        /// <summary>Snaps the angle to nearest interval of degrees.
        ///     <para />
