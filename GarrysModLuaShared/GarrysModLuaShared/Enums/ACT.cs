namespace GarrysModLuaShared.Enums
{
    public enum ACT
    {
        ...
        ACT_GMOD_GESTURE_ITEM_DROP = 1959,
        ACT_GMOD_GESTURE_ITEM_GIVE = 1958,
        ACT_GMOD_GESTURE_ITEM_PLACE = 1960,
        ACT_GMOD_GESTURE_ITEM_THROW = 1961,
        ACT_GMOD_GESTURE_MELEE_SHOVE_1HAND = 1963,
        ACT_GMOD_GESTURE_MELEE_SHOVE_2HAND = 1962,
        ...
        ACT_GMOD_IN_CHAT = 1957,
        ACT_GMOD_NOCLIP_LAYER = 1897,
        ACT_GMOD_SIT_ROLLERCOASTER = 1912,
        ...
        ACT_HL2MP_GESTURE_RANGE_ATTACK_FIST = 1903,
        ACT_HL2MP_GESTURE_RANGE_ATTACK_GRENADE = 1842,
        ACT_HL2MP_GESTURE_RANGE_ATTACK_KNIFE = 1918,
        ACT_HL2MP_GESTURE_RANGE_ATTACK_MAGIC = 1658,
        ACT_HL2MP_GESTURE_RANGE_ATTACK_MELEE = 1882,
        ACT_HL2MP_GESTURE_RANGE_ATTACK_MELEE2 = 1938,
        ACT_HL2MP_GESTURE_RANGE_ATTACK_PASSIVE = 1928,
        ...
        ACT_HL2MP_GESTURE_RELOAD_FIST = 1904,
        ACT_HL2MP_GESTURE_RELOAD_GRENADE = 1843,
        ACT_HL2MP_GESTURE_RELOAD_KNIFE = 1919,
        ACT_HL2MP_GESTURE_RELOAD_MAGIC = 1659,
        ACT_HL2MP_GESTURE_RELOAD_MELEE = 1883,
        ACT_HL2MP_GESTURE_RELOAD_MELEE2 = 1939,
        ACT_HL2MP_GESTURE_RELOAD_PASSIVE = 1929,
        ...
        ACT_HL2MP_IDLE_CROUCH_FIST = 1901,
        ACT_HL2MP_IDLE_CROUCH_GRENADE = 1840,
        ACT_HL2MP_IDLE_CROUCH_KNIFE = 1916,
        ACT_HL2MP_IDLE_CROUCH_MAGIC = 1656,
        ACT_HL2MP_IDLE_CROUCH_MELEE = 1880,
        ACT_HL2MP_IDLE_CROUCH_MELEE2 = 1936,
        ACT_HL2MP_IDLE_CROUCH_PASSIVE = 1926,
        ...
        ACT_HL2MP_JUMP_FIST = 1905,
        ACT_HL2MP_JUMP_GRENADE = 1844,
        ACT_HL2MP_JUMP_KNIFE = 1920,
        ACT_HL2MP_JUMP_MAGIC = 1660,
        ACT_HL2MP_JUMP_MELEE = 1884,
        ACT_HL2MP_JUMP_MELEE2 = 1940,
        ACT_HL2MP_JUMP_PASSIVE = 1930,
        ...
        ACT_HL2MP_SIT = 1908,
        ACT_HL2MP_SIT_AR2 = 1946,
        ACT_HL2MP_SIT_CROSSBOW = 1950,
        ACT_HL2MP_SIT_FIST = 1953,
        ACT_HL2MP_SIT_GRENADE = 1948,
        ACT_HL2MP_SIT_MELEE = 1951,
        ACT_HL2MP_SIT_PHYSGUN = 1947,
        ACT_HL2MP_SIT_PISTOL = 1943,
        ACT_HL2MP_SIT_RPG = 1949,
        ACT_HL2MP_SIT_SHOTGUN = 1944,
        ACT_HL2MP_SIT_SLAM = 1952,
        ACT_HL2MP_SIT_SMG1 = 1945,
        ...
        ACT_HL2MP_SWIM_IDLE_FIST = 1906,
        ACT_HL2MP_SWIM_IDLE_GRENADE = 1845,
        ACT_HL2MP_SWIM_IDLE_KNIFE = 1921,
        ACT_HL2MP_SWIM_IDLE_MAGIC = 1661,
        ACT_HL2MP_SWIM_IDLE_MELEE = 1885,
        ACT_HL2MP_SWIM_IDLE_MELEE2 = 1941,
        ACT_HL2MP_SWIM_IDLE_PASSIVE = 1932,
        ...
        ACT_HL2MP_SWIM_KNIFE = 1922,
        ACT_HL2MP_SWIM_MAGIC = 1662,
        ACT_HL2MP_SWIM_MELEE = 1886,
        ACT_HL2MP_SWIM_MELEE2 = 1942,
        ACT_HL2MP_SWIM_PASSIVE = 1931,
        ...
        ACT_HL2MP_WALK_CROUCH_FIST = 1902,
        ACT_HL2MP_WALK_CROUCH_GRENADE = 1841,
        ACT_HL2MP_WALK_CROUCH_KNIFE = 1917,
        ACT_HL2MP_WALK_CROUCH_MAGIC = 1657,
        ACT_HL2MP_WALK_CROUCH_MELEE = 1881,
        ACT_HL2MP_WALK_CROUCH_MELEE2 = 1937,
        ACT_HL2MP_WALK_CROUCH_PASSIVE = 1927,
        ...
        ACT_HL2MP_WALK_FIST = 1899,
        ACT_HL2MP_WALK_GRENADE = 1838,
        ACT_HL2MP_WALK_KNIFE = 1914,
        ACT_HL2MP_WALK_MAGIC = 1654,
        ACT_HL2MP_WALK_MELEE = 1878,
        ACT_HL2MP_WALK_MELEE2 = 1934,
        ACT_HL2MP_WALK_PASSIVE = 1924,
