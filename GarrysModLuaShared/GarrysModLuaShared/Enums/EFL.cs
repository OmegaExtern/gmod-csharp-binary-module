namespace GarrysModLuaShared.Enums
{
    public enum EFL
    {
        ...
        /// <summary>
        ///     The default behavior in ShouldTransmit is to not send an entity if it doesn't have a model. Certain entities
        ///     want to be sent anyway because all the drawing logic is in the client DLL. They can set this flag and the engine
        ///     will transmit them even if they don't have model
        /// </summary>
        ...
        /// <summary>
        ///     This is set if the entity detects that it's in the skybox. This forces it to pass the "in PVS" for
        ///     transmission
        /// </summary>
