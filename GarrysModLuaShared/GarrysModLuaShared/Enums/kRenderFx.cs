namespace GarrysModLuaShared.Enums
{
    public enum kRenderFx
    {
        ...
        /// <summary>
        ///     Slowly fades away the entity, making it completely invisible.Starts from whatever alpha the entity currently
        ///     has set.
        /// </summary>
        kRenderFxFadeSlow = 5,

        /// <summary>
        ///     Quickly fades away the entity, making it completely invisible.Starts from whatever alpha the entity currently
        ///     has set.
        /// </summary>
        kRenderFxFadeFast = 6,
