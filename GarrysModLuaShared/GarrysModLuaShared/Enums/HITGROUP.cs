namespace GarrysModLuaShared.Enums
{
    ...
    {
        /// <summary>1:1 damage. This hitgroup is not present on default player models.It is unknown how this is generated in GM:ScalePlayerDamage, but it occurs when shot by NPCs ( npc_combine_s ) for example.</summary>
        HITGROUP_GENERIC = 0,
