...
namespace GarrysModLuaShared
{
    ...
    static class system
    {
        ...
        public static uint AppTime(IntPtr luaState)
        {
            lock (SyncRoot)
            {
        ...
        public static byte BatteryPower(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
        ...
        /// <param name="luaState">Pointer to lua_State struct.</param>
        public static void FlashWindow(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
        ...
        public static string GetCountry(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
        ...
        public static bool HasFocus(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
        ...
        public static bool IsLinux(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
        ...
        public static bool IsOSX(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
        ...
        public static bool IsWindowed(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
        ...
        public static bool IsWindows(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
        ...
        public static uint SteamTime(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
        ...
        public static uint UpTime(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(system));
