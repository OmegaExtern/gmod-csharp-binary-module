...
namespace GarrysModLuaShared
{
    ...
    static class engine
    {
        ...
        public static string ActiveGamemode(IntPtr luaState)
        {
            lock (SyncRoot)
            {
        ...
        /// <param name="luaState">Pointer to lua_State struct.</param>
        public static void CloseServer(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        /// <param name="luaState">Pointer to lua_State struct.</param>
        /// <returns></returns>
        public static double GetDemoPlaybackStartTick(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static double GetDemoPlaybackTick(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static double GetDemoPlaybackTimeScale(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static double GetDemoPlaybackTotalTicks(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static bool IsPlayingDemo(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static bool IsRecordingDemo(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static void LightStyle(IntPtr luaState, double lightstyle, string pattern)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static string OpenDupe(IntPtr luaState, string dupeName)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static double TickInterval(IntPtr luaState)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static void WriteDupe(IntPtr luaState, string dupe, string jpeg)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
        ...
        public static void WriteSave(IntPtr luaState, string saveData, string name, double time, string map)
        {
            lock (SyncRoot)
            {
                lua_getglobal(luaState, nameof(engine));
